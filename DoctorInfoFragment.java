    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        if (getArguments() != null) {
            ...
            textViewField.setText(
                    getArguments().getString(FindDoctorsFragment.DOCTOR_FIELD)
            );

            textViewQualification.setText(
                    getArguments().getString(FindDoctorsFragment.DOCTOR_QUALIFICATION)
            );
        }

        // 🔥 ALWAYS show the new avatar (ignore old database image)
        imageViewDoctor.setImageResource(R.drawable.doctor_avatar);
