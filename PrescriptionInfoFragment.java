...
/* ⭐ IMPORTANT IMPORT THAT FIXES YOUR ERROR */
...
public class PrescriptionInfoFragment extends Fragment {
    ...
    // 🔹 Local prescription (NO FIREBASE)
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        // 🔹 Receive demo data from bundle
        if (getArguments() != null) {

            String doctor = getArguments().getString("doctorName");
            String medicine = getArguments().getString("medicine");
            String patient = getArguments().getString("patientName");
    ...
    private void savePrescription() {
        ...
        Toast.makeText(getContext(), "Prescription Updated (Demo)", Toast.LENGTH_SHORT).show();
